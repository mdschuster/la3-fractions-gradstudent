...
import edu.wit.cs.comp5900.LA3a;
...
public class LA3aTestCase extends TestCase {
	...
	private void _testSimplify(int n, int d, int eN, int eD) {
		int[] result = null;
		try {
			result = LA3a.simplifyFraction(new int[] {n, d});
		} catch (ExitException e) {}
	...
	private void _testAdd(int num1, int den1, int num2, int den2, int eNum, int eDen) {
		int[] result = null;
		try {
			result = LA3a.addFractions(new int[] {num1, den1}, new int[] {num2, den2});
		} catch (ExitException e) {}
	...
	private void _testSubtract(int num1, int den1, int num2, int den2, int eNum, int eDen) {
		int[] result = null;
		try {
			result = LA3a.subtractFractions(new int[] {num1, den1}, new int[] {num2, den2});
		} catch (ExitException e) {}
		assertArrayEquals(new int[] {eNum, eDen}, result);
	}
	...
	private void _testMultiply(int num1, int den1, int num2, int den2, int eNum, int eDen) {
		int[] result = null;
		try {
			result = LA3a.multiplyFractions(new int[] {num1, den1}, new int[] {num2, den2});
		} catch (ExitException e) {}
		assertArrayEquals(new int[] {eNum, eDen}, result);
	}
	...
	private void _testDivide(int num1, int den1, int num2, int den2, int eNum, int eDen) {
		int[] result = null;
		try {
			result = LA3a.divideFractions(new int[] {num1, den1}, new int[] {num2, den2});
		} catch (ExitException e) {}
		assertArrayEquals(new int[] {eNum, eDen}, result);
	}
	...
	public void testDivZero() {
		_test(new String[] {"1", "2", "0", "4", "/"}, E_DIV_ZERO);
	}
